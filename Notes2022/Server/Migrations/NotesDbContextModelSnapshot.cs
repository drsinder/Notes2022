...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Notes2022.Server.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Notes2022.Shared.Audit", b =>
                {
            ...
            modelBuilder.Entity("Notes2022.Shared.HomePageMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Notes2022.Shared.LinkedFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Notes2022.Shared.LinkQueue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Notes2022.Shared.Mark", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)")
            ...
            modelBuilder.Entity("Notes2022.Shared.NoteAccess", b =>
                {
                    b.Property<string>("UserID")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)")
            ...
            modelBuilder.Entity("Notes2022.Shared.NoteContent", b =>
                {
                    b.Property<long>("NoteHeaderId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Notes2022.Shared.NoteFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Notes2022.Shared.NoteHeader", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Notes2022.Shared.Search", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Notes2022.Shared.Sequencer", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)")
            ...
            modelBuilder.Entity("Notes2022.Shared.SQLFile", b =>
                {
            ...
            modelBuilder.Entity("Notes2022.Shared.SQLFileContent", b =>
                {
            ...
            modelBuilder.Entity("Notes2022.Shared.Subscription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Notes2022.Shared.Tags", b =>
                {
            ...
            modelBuilder.Entity("Notes2022.Shared.TZone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Notes2022.Server.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Notes2022.Shared.Mark", b =>
                {
                    b.HasOne("Notes2022.Shared.NoteFile", "NoteFile")
                        .WithMany()
            ...
            modelBuilder.Entity("Notes2022.Shared.NoteContent", b =>
                {
                    b.HasOne("Notes2022.Shared.NoteHeader", "NoteHeader")
                        .WithOne("NoteContent")
                        .HasForeignKey("Notes2022.Shared.NoteContent", "NoteHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("NoteHeader");
                });
            ...
            modelBuilder.Entity("Notes2022.Shared.SQLFileContent", b =>
                {
                    b.HasOne("Notes2022.Shared.SQLFile", "SQLFile")
                        .WithOne("Content")
                        .HasForeignKey("Notes2022.Shared.SQLFileContent", "SQLFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
